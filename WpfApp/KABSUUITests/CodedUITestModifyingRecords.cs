...
namespace KABSUUITests
{
    ...
    /// </summary>
    [CodedUITest]
    public class CodedUITestModifyingRecords
    {
        public CodedUITestModifyingRecords()
        {
        }
        /// <summary>
        /// This test to verify the ability to open a record window after searhicng for it.
